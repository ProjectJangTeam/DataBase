-- jang_member
INSERT INTO jangdb.jang_member (ID, PWD, NNAME, SIDATE, PROFILE, NAME, EMAIL, PNUM, BIRTH, GENDER, SNS, MBTI) VALUES ('user1', '0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c', 'juser1', '2022-10-06', null, 'JANG', 'user1@test.com', '01000000000', '1996-03-24', 'F', null, 'ESTJ');
INSERT INTO jangdb.jang_member (ID, PWD, NNAME, SIDATE, PROFILE, NAME, EMAIL, PNUM, BIRTH, GENDER, SNS, MBTI) VALUES ('user2', '0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c', 'Muser1', '2022-10-06', null, 'MIN', 'user2@test.com', '01100000000', '1996-07-26', 'M', null, 'ISFJ');
INSERT INTO jangdb.jang_member (ID, PWD, NNAME, SIDATE, PROFILE, NAME, EMAIL, PNUM, BIRTH, GENDER, SNS, MBTI) VALUES ('user3', '0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c', 'user3', '2022-10-10', null, 'user3', 'user3@test.com', '12345678906', '2022-10-10', 'm', null, null);
INSERT INTO jangdb.jang_member (ID, PWD, NNAME, SIDATE, PROFILE, NAME, EMAIL, PNUM, BIRTH, GENDER, SNS, MBTI) VALUES ('user4', '0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c', 'Kimuser', '2022-09-09', null, 'HKyung', 'Kim@test.com', '01034567890', '1996-03-03', 'M', null, 'ISFJ');
INSERT INTO jangdb.jang_member (ID, PWD, NNAME, SIDATE, PROFILE, NAME, EMAIL, PNUM, BIRTH, GENDER, SNS, MBTI) VALUES ('user5', '0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c', 'Parkuser', '2022-10-01', null, 'Mingu', 'Park@test.com', '01099999999', '1995-12-10', 'f', null, 'ISFJ');
INSERT INTO jangdb.jang_member (ID, PWD, NNAME, SIDATE, PROFILE, NAME, EMAIL, PNUM, BIRTH, GENDER, SNS, MBTI) VALUES ('user6', '0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c', 'Uuser', '2022-10-03', null, 'Jimin', 'Uuser@test.com', '01087654321', '1994-11-10', 'm', null, 'ISFJ');
INSERT INTO jangdb.jang_member (ID, PWD, NNAME, SIDATE, PROFILE, NAME, EMAIL, PNUM, BIRTH, GENDER, SNS, MBTI) VALUES ('user7', '0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c', 'Gooduser', '2022-10-06', null, 'Kaon', 'Gooduser@test.com', '01098765432', '1993-10-04', 'f', null, 'ISFJ');
INSERT INTO jangdb.jang_member (ID, PWD, NNAME, SIDATE, PROFILE, NAME, EMAIL, PNUM, BIRTH, GENDER, SNS, MBTI) VALUES ('user8', '0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c', 'Baduser', '2022-10-10', null, 'Tonghyun', 'Baduser@test.com', '01009876543', '1992-10-10', 'm', null, null);
...
INSERT INTO jangdb.jang_so_review (PRVNO, CONT, RECONO, PLNO) VALUES (2, '정선 레일바이크 출발지는 구절리역으로, 예전 열차 선로 그대로 보존이 되어 있다. 메뚜기 모양의 카페가 있고 그 뒤로는 열차펜션이 위치해 있다. 시설은 좋아보이지 않으나, 새마을호나 무궁화호 등으로 열차여행을 오시는 분들한텐 펜션 이용도 괜찮을 것 같다.', 2, 1);
INSERT INTO jangdb.jang_so_review (PRVNO, CONT, RECONO, PLNO) VALUES (3, '화암약수까지 차가 올라갈 수 있어 어찌나 다행이던지... 이 추위에 걸으라 했으면 나는 꼼짝없이 동장군이 되어 굳어 버렸을거다. 심지어 정선 여행 내내 너무 추워 기억의 절반은 날아간 것 같은 기분이다.', 3, 2);
INSERT INTO jangdb.jang_so_review (PRVNO, CONT, RECONO, PLNO) VALUES (4, '강원도 국가지질공원 코스는 화암 동굴! 지질명소 중 꽤 유명한 곳으로 통하고 있으며 카르스트지형으로 석회암의 용식 작용으로 만들어진 곳이다.', 4, 3);
